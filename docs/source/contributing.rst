...
.. code-block:: bash
    ...
    $ git clone https://github.com/dan-elias/tkipy.git
    $ cd tkipy
...
Documentation is also hosted online at: `Read the Docs <https://tkipy.readthedocs.io/en/latest/>`_
